---
title: "Optics — Can We Print a Lens?"
date: 2026-06-03
draft: false
...
**FDM — clear PLA**
Printed on the Kobra X. Surface finish from FDM is rough at the layer scale — likely too much scatter for a clean focus, but worth seeing what you actually get.

**Resin — clear resins**
Better surface resolution and the material can be optically transparent after curing and polishing. More promising. Several clear resins ordered for this:

- ABS-Like 2.0 Clear — structural, less brittle
- Standard Clear — higher detail
- High Clear / Transparent resin

See [3D Printing](/garage/3d-printing/) for the full resin inventory.
