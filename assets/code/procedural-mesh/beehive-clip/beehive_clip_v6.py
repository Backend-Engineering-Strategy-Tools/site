...
BAR_GRIP   = 18.0   # mm  arm hang depth below bar top surface  ← v3: was 8

# Clip body
BAR_SPACER =  4.0   # mm  spacer protrusion on right arm outer face (bee-space bump)
WALL       =  6.0   # mm  arm wall thickness (X, both sides)
WALL_TOP   =  4.0   # mm  top bridge thickness (Y)
CLIP_LEN   =  6.0   # mm  clip length along bar (Z)

# Barb — ramp tooth: long angled entry face (easy slide in), horizontal catch (hard pull-off)
BARB_BITE  =  4     # mm  inward bite (X toward bar centre)
BARB_W     =  3.0   # mm  tooth height (Y)
BARB_Y     = 16.0   # mm  barb centre depth from bar top  ← v3: was 6, slides down with arm
...
INS_RIGHT                = "V6"         # right arm cross-section
