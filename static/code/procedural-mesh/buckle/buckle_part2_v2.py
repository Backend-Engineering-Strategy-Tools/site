...
# Lock plate (flat disc with centre hole + T-slot)
LOCK_T    =  2.5    # plate thickness
T_STEM_W  =  8.0    # T stem width (insertion channel)
T_BAR_W   = 22.0    # T cross bar width (locking groove)
T_BAR_D   =  7.0    # T cross bar depth
...
def build_part2():
    ...
    dome_obj = dome_with_hole(disc_cx, 0, DOME2_Z_RISE, DOME2_D/2, DOME2_H, HOLE_D/2)
